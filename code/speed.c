...
int main(){
    ...
    char color;
    int sdir;                                                                         //Neopixel Color Variable Declaration
    ...
    while(true){
        ...
        switch(operation){                                                              //Switch Case for execution of requested operation
            case 'r':                                                                  //Record or Acquire Mode Case
                sleep_ms(10);
                printf(" Which speed do you want:\n");
                scanf(" %c",&sdir);  
                printf("Recording in Progress\n");
                record(recording,3,sdir);                                                   //Calling Record Function, you can trace this to button_capture.c
                printf("\nRecord Ended\n");
                break;
            ...
            case 'l':
                ...
                loopplay(recording,3,color,sdir);                               
                printf("Replay Ended:\n");
                break;
            case 'u':                                                                  
